// Copyright 2022 Communication Protocols Team (skel)
...
/* Copyright Communication Protocols Team 2021 - last year's skel
 * The next functions are from the last year's skel and are not written
 * by myself. They existed in the first version of this year's skel, and
 * I used them before the skel was changed.
 */
